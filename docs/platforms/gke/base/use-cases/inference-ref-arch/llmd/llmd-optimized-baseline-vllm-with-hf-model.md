...
This guide is an extension of
[llm-d optimized baseline well-lit path](https://github.com/llm-d/llm-d/tree/main/guides/optimized-baseline).
In this guide, you will see how you can install llmd optimized-baseline well-lit
...
The `deploy-llmd-optimized-baseline.sh` script will perform the following steps:
...
```shell
${ACP_REPO_DIR}/platforms/gke/base/use-cases/inference-ref-arch/terraform/teardown-llmd-optimized-baseline.sh
```
